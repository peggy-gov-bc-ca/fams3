...
namespace  DynamicsAdapter.Web.Mapping
{
    ...
    public class MappingProfile : Profile
    {
        ...
        {
            //should use swagger one
            CreateMap<SSG_Identifier, PersonalIdentifierActual>()
            ...
            CreateMap<SSG_Address, AddressActual>()
            ...
            CreateMap<SSG_PhoneNumber, PhoneNumberActual>()
            ...
            //use bcGov artifacts one
            CreateMap<BcGov.Fams3.SearchApi.Contracts.Person.PersonalIdentifier, SSG_Identifier>()
               .ForMember(dest => dest.Identification, opt => opt.MapFrom(src => src.Value))
               //.ForMember(dest => dest.IdentificationEffectiveDate, opt => opt.MapFrom<IdentificationEffectiveDateResolver>())
               //.ForMember(dest => dest.IdentificationExpirationDate, opt => opt.MapFrom<IdentificationExpirationDateResolver>())
               ...
               .ForMember(dest => dest.Notes, opt => opt.MapFrom(src => src.Notes))
               //.ForMember(dest => dest.Date1, opt => opt.MapFrom(src => src.TypeCode))
               //.ForMember(dest => dest.Note2, opt => opt.MapFrom(src => src.Notes))
